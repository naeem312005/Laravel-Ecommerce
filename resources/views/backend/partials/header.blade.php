<div class="header-dashboard">
  <div class="wrap">
    <div class="header-left">
      <a href="index-2.html">
        <img class="" id="logo_header_mobile" alt="" src="{{ asset('backend/assets') . "/images/logo/logo.png" }}"
          data-light="{{ asset('backend/assets') . "/images/logo/logo.png" }}"
          data-dark="{{ asset('backend/assets') . "/images/logo/logo.png" }}" data-width="154px" data-height="52px"
          ...
          <ul class="mb-24">
            ...
            <li>
              <ul>
                ...
                <li class="product-item gap14 mb-10">
                  <div class="image no-bg">
                    <img src="{{ asset('backend/assets') . "/images/products/18.png" }}" alt="" />
                  </div>
                  <div class="flex items-center justify-between gap20 flex-grow">
                    <div class="name">
                ...
                <li class="product-item gap14">
                  <div class="image no-bg">
                    <img src="{{ asset('backend/assets') . "/images/products/19.png" }}" alt="" />
                  </div>
                  <div class="flex items-center justify-between gap20 flex-grow">
                    <div class="name">
          ...
          <ul class="">
            ...
            <li>
              <ul>
                <li class="product-item gap14 mb-10">
                  <div class="image no-bg">
                    <img src="{{ asset('backend/assets') . "/images/products/20.png" }}" alt="" />
                  </div>
                  <div class="flex items-center justify-between gap20 flex-grow">
                    <div class="name">
                ...
                <li class="product-item gap14 mb-10">
                  <div class="image no-bg">
                    <img src="{{ asset('backend/assets') . "/images/products/21.png" }}" alt="" />
                  </div>
                  <div class="flex items-center justify-between gap20 flex-grow">
                    <div class="name">
                ...
                <li class="product-item gap14 mb-10">
                  <div class="image no-bg">
                    <img src="{{ asset('backend/assets') . "/images/products/22.png" }}" alt="" />
                  </div>
                  <div class="flex items-center justify-between gap20 flex-grow">
                    <div class="name">
                ...
                <li class="product-item gap14">
                  <div class="image no-bg">
                    <img src="{{ asset('backend/assets') . "/images/products/23.png" }}" alt="" />
                  </div>
                  <div class="flex items-center justify-between gap20 flex-grow">
                    <div class="name">
                      <a href="product-list.html" class="body-text">Mega Pumpkin Bone</a>
        ...
        <div class="dropdown">
          <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton3"
            ...
            <span class="header-user wg-user">
              <span class="image">
                <img src="{{ asset('backend/assets') . "/images/avatar/user-1.png" }}" alt="" />
              </span>
          ...
          <ul class="dropdown-menu dropdown-menu-end has-content" aria-labelledby="dropdownMenuButton3">
            ...
            <li>
              ...
              <form action="{{ route('logout') }}" method="post">
                @csrf
                <button class="body-title-2 "><i class="icon-log-out"></i>Log out</button>
              </form>
            </li>
          </ul>
        </div>
